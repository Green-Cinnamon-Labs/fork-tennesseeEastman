...
As premissas de design que governam esta refatoração — ordem do loop, escrita em XMV e responsabilidade da trait — estão registradas em `docs/1.md § Premissas para o Desacoplamento dos Controladores da Planta`.
